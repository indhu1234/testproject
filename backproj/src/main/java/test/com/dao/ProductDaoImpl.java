...
public ProductDaoImpl(){
     ...
     */
	public boolean saveProduct(Product product) {//id=0,productname="pen",productdesc="pen",price=100,quantity=10
        	...
        	session.saveOrUpdate(product); //generate an insert query, insert the data into product table
