...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="topnav">
      <a class="navbar-brand"  href="#"><b>Mobile online shopping</b></a>
    </div>
...
<%-- <c:if test="${sessionScope.loggedIn}">
   ...
   <ul class="nav navbar-nav">
      <li>
<a href="showCategory">Category</a></li>
   
   <li>
   <li>
<a href="showSupplier">Supplier</a></li>
   
   <li>
<a href="showProduct">Product</a></li>
    </ul>
